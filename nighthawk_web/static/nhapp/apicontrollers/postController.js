(function(){
	...
	function GetDataRegistry($scope, ngDialog, DTOptionsBuilder, DTColumnBuilder, DTDefaultOptions, $http, $routeParams, $cookies) {
	    ...
	    vm.dtColumns = [
		    ...
		    DTColumnBuilder.newColumn('_source.Record.Comment[0].Date').withTitle('Comment Date'),
		    DTColumnBuilder.newColumn('_source.Record.Comment[0].Analyst').withTitle('Comment Analyst'),
		    DTColumnBuilder.newColumn('_source.Record.Comment[0].Comment').withTitle('Comment'),
