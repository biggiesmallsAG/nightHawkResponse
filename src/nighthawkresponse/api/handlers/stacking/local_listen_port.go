...
func StackLocalListenPort(w http.ResponseWriter, r *http.Request) {
	...
	if sc.IgnoreGood {
		query = elastic.NewBoolQuery().
			Must(elastic.NewTermQuery("AuditType.Generator", "w32ports"), elastic.NewTermQuery("Record.State.keyword", "LISTENING"), elastic.NewWildcardQuery("CaseInfo.CaseName", sc.CaseName)).
