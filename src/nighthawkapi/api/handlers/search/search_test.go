...
func TestTimelineSearch(t *testing.T) {
    ...
    config = getTimelineConfig()
    config.CaseName = "SICHUANPEPPER"
    config.ComputerList = []string{"L68F728212093", "CNWS-03871400"}
    timelineSearch(t, config)
}
