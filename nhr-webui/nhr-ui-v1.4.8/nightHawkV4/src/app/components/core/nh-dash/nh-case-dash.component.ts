...
export class NhCaseDashComponent implements OnInit {
	...
	getCaseDateFromEndpoint(_endpoint: string) {
	...
	getAuditDateFromEndpoint(_case_date: string) {
	...
	getAuditDataFromAuditType(_audittype: string) {
