...
export class NhStackComponent implements OnInit {
	...
	public filterGood: boolean = false;
	private gridInit: boolean = true;
	private ctxgridInit: boolean = true;
	public stackResponse: Array<Object>;
	...
	public stackableObjects: Array<Object> = [
	...
	getStack(model: StackHandler, isValid: boolean, event: Event) {
